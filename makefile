...
OBJ_DIR = obj/debug/
BIN_DIR = bin/debug/
CFLAGS = -Wall -g -mfma -mavx2 -Isrc/headers
...
OBJ_DIR = obj/exec/
BIN_DIR = bin/exec/
CFLAGS = -O3 -ffast-math -mfma -mavx2 -march=native -mtune=native -Isrc/headers
endif
...
final:
	$(CC) -O3 -ftree-loop-im -mfma -mavx2 -march=native -mtune=native -Isrc/headers $(LDFLAGS1) $(CPLEX_HEADERS_COMPILER_FLAG) $(SRC_FILES_PATH) -o bin/exec/main $(LDFLAGS2)
