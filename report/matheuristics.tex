...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.73]{local-branching_cost.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.73]{cmp_hardfix_local-branching.pdf}
	\caption{Comparison between Hard Fixing and Local Branching solution quality \label{fig:hardFixLocBranchCMP}}
\end{figure}

\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.73]{cmp_iter-s_hardfix_local-branching.pdf}
